...
for (let [key, value] of Object.entries(commandos)) {
    ...
    /*if (key === "commandooutput" + commandoOutputIndexer) {
        value = value.replace(/&/g, "<br>");
        commandlist.innerHTML += value;
        commandoOutputIndexer += 1;
        ...
        if (document.cookie !== "") {
            ...
            for(var i = 0; i <ca.length; i++) {
                ...
                if (c.indexOf(readname) === 0) {
                   ...
                   // console.log(c.substring(readname.length, c.length));
